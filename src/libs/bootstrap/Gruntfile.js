...
module.exports = function (grunt) {
  ...
  grunt.registerTask('scss-compile', ['exec:scss', 'exec:scss-docs'])

  grunt.registerTask('dist-css', ['scss-compile', 'exec:postcss', 'exec:clean-css', 'exec:clean-css-docs'])
