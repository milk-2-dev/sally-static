...
module.exports = function(grunt) {
	...
	grunt
		.initConfig({
			...
			watch: {
				...
				sass: {
					files: [ 'src/**/*.scss' ],
					tasks: [ 'scss:dist', 'cssmin:dist', 'usebanner:dist', 'copy:distToDocs' ]
				},
				jsDocs: {
	...
	// tasks
	grunt.registerTask('dist', [ 'clean:dist', 'scss:dist', 'autoprefixer', 'concat:dist', 'cssmin:dist', 'copy:distImages', 'jscs:dist', 'usebanner:dist', 'uglify:dist', 'copy:readme' ]);

	grunt.registerTask('docs', [ 'dist', 'clean:docs', 'assemble', 'scss:docs', 'copy:docsAssets', 'copy:distToDocs', 'zip' ]);
